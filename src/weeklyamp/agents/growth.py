...
class GrowthAgent(AgentBase):
    ...
    default_system_prompt = (
        "You are the Growth Manager for TrueFans NEWSLETTERS. "
    ...
    def suggest_tactics(self, task_id: int) -> dict:
        ...
        prompt = (
            f"Suggest 5 growth tactics for TrueFans NEWSLETTERS, "
    ...
    def plan_referral(self, task_id: int) -> dict:
        ...
        prompt = (
            f"Design a referral campaign for TrueFans NEWSLETTERS "
